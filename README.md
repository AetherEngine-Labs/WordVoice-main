...
- **源代码（Source Code）**：采用 Apache License 2.0。
- **预训练模型（Model Checkpoints）**：采用 Apache License 2.0。
- **WordVoice-5A 数据集**：采用独立的数据集许可证，具体请参阅 WordVoice-5A 数据集仓库中的 License 说明。

Apache License 2.0 允许商业使用、修改、再分发以及构建衍生作品。

使用 WordVoice-5A 数据集时，请遵循其对应的数据集许可证。
...
This project consists of three independently licensed components:

- **Source Code**: Released under the Apache License 2.0.
- **Pre-trained Model Checkpoints**: Released under the Apache License 2.0.
- **WordVoice-5A Dataset**: Distributed under its own dataset license. Please refer to the WordVoice-5A repository for detailed terms and conditions.

Commercial use, modification, and redistribution of the source code and released model checkpoints are permitted under the Apache License 2.0.

Please ensure that you comply with the corresponding license when using the dataset.
